...
// Base owner dictionary gate: the original 210 rows remain intact, while build-time wiring upgrades persona to v5.
...
assert.ok(persona.includes('import { bellaKuwaitLexiconInstruction } from "./bella-kuwait-lexicon-v5.js";'), 'persona must import combined lexicon v5 after build wiring');
...
console.log('Bella exact Kuwaiti style smoke test passed: base 210/210 + lexicon v5 wiring, contextual injection, privacy guard, routine flavor, dialect safety and serious-context safeguards are present.');
