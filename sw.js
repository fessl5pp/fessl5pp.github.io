const CACHE_NAME = "bella-pwa-v34-comprehensive-qa";
// Bella v34 refreshes the shell cache and intentionally precaches only normal-user runtime.
// Owner/moderator/deferred modules are cached on first use by the runtime fetch handler.
// Previous validated cache markers retained for regression compatibility: bella-pwa-v33-avatar-10, bella-pwa-v31-release-30, bella-pwa-v26-release-25, bella-pwa-v25-release-24, bella-pwa-v24-release-23, bella-pwa-v23-release-22, bella-pwa-v22-release-21, bella-pwa-v21-release-19, bella-pwa-v20-release-18, bella-pwa-v19-release-17, bella-pwa-v18-release-16, bella-pwa-v17-release-15, bella-pwa-v16-release-14, bella-pwa-v15-release-13, bella-pwa-v14-release-12, bella-pwa-v13-release-11, bella-pwa-v12-release-10, bella-pwa-v11-stable-7
...
const CORE = [
  "/", "/index.html", "/style.css?v=11", "/bella-vnext.css?v=11", "/bella-visual-v32.css?v=32", "/app.js?v=11", "/bella-avatar-v10.webp",
  ...
  "/bella-brain-v2.js?v=30", "/bella-quality-v23.js?v=30", "/bella-memory-v3.js?v=30", "/bella-memory-v4.js?v=30", "/bella-memory-v5.js?v=30", "/bella-style.js?v=30", "/bella-personality-v3.js?v=30",
  "/bella-auth-bridge.js?v=30", "/bella-runtime.js?v=30", "/bella-voice.js?v=30", "/bella-voice-v2.js?v=30",
  "/bella-vnext.js?v=30", "/bella-avatar.js?v=30", "/bella-live-web.js?v=30", "/bella-account-memory-v30.js?v=30",
  "/bella-account-center.js?v=30", "/bella-speed.js?v=30", "/bella-ui.js?v=30",
  "/bella-game-bank-v2.js?v=30", "/bella-game-bank-v3.js?v=30", "/bella-content-cloud.js?v=30", "/bella-kuwaiti-games-data.js?v=30", "/bella-ultimate-content.js?v=30", "/bella-feature-controls-v3.js?v=30", "/bella-resilience-v22.js?v=30", "/bella-season-v20.js?v=30", "/bella-game-mind.js?v=30", "/bella-moments-ui.js?v=30", "/bella-alive.js?v=30", "/bella-moments-feedback.js?v=30", "/bella-ai-activities.js?v=30", "/bella-broadcasts-v19.js?v=30",
  "/bella-install.js?v=30", "/manifest.json", "/favicon.svg"
];
...
async function warmCore() {
  ...
  try {
    ...
    // Do not throw away the entire offline shell because one optional request had
    // a transient failure. Retry individually and keep every asset that succeeds.
