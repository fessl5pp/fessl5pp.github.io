...
export function bellaFindKuwaitLexicon(message) {
  return [...bellaFindKuwaitLexicon(message), ...bellaFindKuwaitLexiconB2(message)];
}
...
export function bellaKuwaitLexiconRow(id, source = "owner_b1") {
  return source === "owner_b2" ? bellaKuwaitLexiconB2Row(id) : bellaKuwaitLexiconRow(id);
}
