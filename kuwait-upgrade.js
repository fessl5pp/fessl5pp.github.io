/* Bella Kuwait Mega Upgrade v5 - full Kuwaiti personality packs */
(function(){
  const KUWAIT_PACK = {
  ...
  function installSuggestionPatch(){
    ...
    window.updateSuggestions=function(context=""){ if(typeof oldUpdate==="function") oldUpdate(context); const bar=document.getElementById("rumor-bar"); if(bar) bar.remove(); };
